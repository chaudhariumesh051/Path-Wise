...
import { User, Mail, Camera, Save, AlertCircle, CheckCircle, Moon, Sun } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-light-border dark:border-dark-border">
        <div className="p-6 border-b border-light-border dark:border-dark-border">
          <h2 className="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary">Appearance</h2>
        </div>
        <div className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-medium text-light-text-primary dark:text-dark-text-primary">Theme</h3>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-light-primary dark:focus:ring-dark-primary focus:ring-offset-2 ${
                isDark ? 'bg-light-primary' : 'bg-light-border dark:bg-dark-border'
              }`}
            >
              <span
      ...
      <div className="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-light-border dark:border-dark-border">
        <div className="p-6 border-b border-light-border dark:border-dark-border">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary">Profile Information</h2>
            {!isEditing && (
              <button
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <label className="block text-sm font-medium text-light-text-primary dark:text-dark-text-primary">Profile Picture</label>
            <div className="flex items-center space-x-4">
              ...
              {isEditing && (
                <div className="flex-1">
                  <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-3">Choose from predefined avatars:</p>
          ...
          <div className="space-y-2">
            <label htmlFor="fullName" className="block text-sm font-medium text-light-text-primary dark:text-dark-text-primary">
              Full Name
            </label>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Email address cannot be changed</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-lg">
              <p className="text-sm text-light-text-primary dark:text-dark-text-primary">{profile?.goal || 'No goal set'}</p>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-light-border dark:border-dark-border">
        <div className="p-6 border-b border-light-border dark:border-dark-border">
          <h2 className="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary">Account Statistics</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-light-primary/10 dark:bg-dark-primary/10 rounded-lg">
              <div className="text-2xl font-bold text-light-primary dark:text-dark-primary">-</div>
              <div className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Lessons Completed</div>
            </div>
            <div className="text-center p-4 bg-light-success/10 dark:bg-dark-accent/10 rounded-lg">
              <div className="text-2xl font-bold text-light-success dark:text-dark-accent">-</div>
              <div className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Hours Studied</div>
            </div>
            <div className="text-center p-4 bg-light-accent/10 dark:bg-dark-primary/10 rounded-lg">
              <div className="text-2xl font-bold text-light-accent dark:text-dark-primary">-</div>
              <div className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Average Score</div>
            </div>
          </div>
        </div>
      </div>
